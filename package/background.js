...
(function() {
  var cacheDecisionPoint, cacheService, cacheUserVote, checkForChanges_HourInterval, checkIfCurrentVersionOfApiServicePointIsInServicesCache, clearServiceCache, getPointsToVoteOn, initIfNewURL, initialize, messageMainView_noServiceMatch, popupOpen, popupParcel, reactor, refreshBadge, sendParcel, serviceMatchObj, servicesIndexAndServicesFullReady, servicesReady, tabUrl, updateBadgeText, updateMainViewData, updateService, updateServicesIndex,
    ...
    return chrome.storage.local.get('servicesFull', function(response) {
      ...
      if ((servicesFull[serviceName] != null) && (servicesFull[serviceName].service.pointsData[pointId] != null)) {
        return chrome.storage.local.get('servicesCache', function(_r) {
          var servicesCache;
          if ((_r.servicesCache == null) || Object.keys(_r.servicesCache).length === 0 || (_r.servicesCache[serviceName] == null) || ((currentTime - _r.servicesCache[serviceName].canonicalTimestamp) > checkForChanges_HourInterval * 3600000)) {

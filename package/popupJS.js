...
(function() {
  $(document).ready(function() {
    var addTargetAttribute, backupView, backupViewElsToUnbind, cachedVotedPoints, capitalizeFirstLetter, cleanupMainView, debugParcelCenterCountPopup, getRandom, historyViewElsToUnbind, htmlEntities, isProbablyAUrl, mainViewElsToUnbind, port, prepViewData, receiveParcel, recentlyVotedPoints, recieved_parcels_popup, renderExtensionHeight, renderHistoryView, renderMainView, renderedBool, sendParcel, thisPoint, userVotes, viewElementId;
    recentlyVotedPoints = [];
    cachedVotedPoints = [];
    viewElementId = '';
    renderedBool = false;
